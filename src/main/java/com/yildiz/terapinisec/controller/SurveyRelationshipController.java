...
public class SurveyRelationshipController {
   ...
   private final  SurveyRelationshipService surveyRelationshipService;
   public SurveyRelationshipController(SurveyRelationshipService surveyRelationshipService) {
       this.surveyRelationshipService = surveyRelationshipService;
   }
